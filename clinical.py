...
:root{
  ...
  --sb-shadow: 0 10px 28px rgba(15,23,42,0.06);
...
/* Remove random extra spacing between widgets in sidebar */
...
/* ---- ONE SHARED "PILL" SYSTEM ----
   Make: selectbox, buttons, and radio items look identical.
*/

/* Selectbox: match pill look */
